...
class VehicleAdapterItem(val item: Vehicle, val clickListener: ClickListener): AdapterItem {
  ...
  override fun bindData(viewHolder: RecyclerView.ViewHolder) {
    ...
    viewHolder.leftImageView.setImageResource(R.drawable.vehicles)
    viewHolder.rightImageView.setImageResource(R.drawable.vehicles)
